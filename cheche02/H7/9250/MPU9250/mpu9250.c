...
{
     HAL_I2C_Mem_Write(&hi2c3, (addr<<1), reg, I2C_MEMADD_SIZE_8BIT, buf, len, 0xfff);
     return 0;
} 
...
{ 
    HAL_I2C_Mem_Read(&hi2c3, (addr<<1), reg, I2C_MEMADD_SIZE_8BIT, buf, len, 0xfff);
    return 0;       
}
...
{
    HAL_I2C_Mem_Write(&hi2c3, (addr<<1), reg, I2C_MEMADD_SIZE_8BIT, &data, 1, 0xfff);
    return 0;
}
...
{
    u8 res;
    HAL_I2C_Mem_Read(&hi2c3, (addr<<1), reg, I2C_MEMADD_SIZE_8BIT, &res, 1, 0xfff);
    return res;  
}
